...
interface StockAlertSettingsModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function StockAlertSettingsModal({
  isOpen,
  onClose,
  onSave,
  initialData,
  productName,
  currentStock,
}: StockAlertSettingsModalProps) {
  const [settings, setSettings] = useState<AlertSettings>(initialData || defaultSettings);
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setSettings({ ...settings, frequency: e.target.value as AlertSettings['frequency'] })}
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600"
              >
